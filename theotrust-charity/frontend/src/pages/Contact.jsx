...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Phone',
      content: '+91 7307 760 329',
      link: 'tel:+917307760329',
    ...
    },
    {
      ...
      title: 'Email',
      content: 'startupthings96@gmail.com',
      link: 'mailto:startupthings96@gmail.com',
          ...
          <div className="md:col-span-8 bg-white rounded-xl shadow-lg p-6 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 text-white py-3 rounded-lg text-sm font-semibold hover:from-indigo-700 hover:via-purple-700 hover:to-blue-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-lg hover:shadow-2xl hover:scale-105 active:scale-95 relative overflow-hidden group"
              >
                ...
                {loading ? (
                  ...
                  <>
                    <Send className="w-5 h-5 mr-2 relative" />
