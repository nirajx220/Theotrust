      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+917307760329" className="text-sm hover:text-blue-400 transition-colors">
                  +91 7307 760 329
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-blue-400 flex-shrink-0" />
                <a href="mailto:startupthings96@gmail.com" className="text-sm hover:text-blue-400 transition-colors">
                  startupthings96@gmail.com
                </a>
              </li>
              <li className="flex items-center space-x-3">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-sm text-gray-400">
            © {currentYear} TheoTrust. All rights reserved. Registered Charity No. 1234567
          </div>
